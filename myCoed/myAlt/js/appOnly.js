...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoActions = {};
	var TodoStore = { listen: function listen() {}, unlisten: function unlisten() {} };
	...
	var routes = React.createElement(Route, { handler: App, path: "/" }, React.createElement(Route, { path: "/index", handler: Index }), React.createElement(Route, { path: "/list", handler: List }), React.createElement(DefaultRoute, { handler: Index }), React.createElement(NotFoundRoute, { handler: NotFound }));
