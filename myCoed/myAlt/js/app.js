...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({ displayName: "App",
	    ...
	    //渲染
	    render: function render() {
	        return React.createElement("div", null, React.createElement("input", { type: "button", onClick: this.handleClick, value: "点击" }), React.createElement(RouteHandler, { key: Date.now() }));
	    }
	...
	var routes = React.createElement(Route, { handler: App }, React.createElement(Route, { path: "/index", handler: Index }), React.createElement(Route, { path: "/list", handler: List }), React.createElement(DefaultRoute, { handler: Index }), React.createElement(NotFoundRoute, { handler: NotFound }));
