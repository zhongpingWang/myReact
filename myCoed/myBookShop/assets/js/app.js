...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoActions = __webpack_require__(1);
	var TodoStore = __webpack_require__(15);
	var React = __webpack_require__(16);
	var ReactDOM = __webpack_require__(173);
	var Router = __webpack_require__(174).Router;
	var Route = __webpack_require__(174).Route;
	var Link = __webpack_require__(174).Link;
	var List = __webpack_require__(225);
	var Index = __webpack_require__(226);
	var Nav = __webpack_require__(227);
	...
	var App = React.createClass({ displayName: "App",
	    ...
	    //改变回调
	    handleChange: function handleChange(pars) {
	        console.log(pars);
	    },
	    ...
	    //渲染
	    render: function render() {
	        return React.createElement("div", null, React.createElement("input", { type: "button", onClick: this.handleClick, value: "点击" }), React.createElement(Nav, null), this.props.children);
	    }
	});
	...
	var routeConfig = [{ path: '/',
	    ...
	    childRoutes: [{ path: 'index', component: Index }, { path: 'index/:id', component: Index }, { path: 'list', component: List }, { path: 'list/:id', component: List }]
	}];

	var history = createHashHistory({ queryKey: false });

	ReactDOM.render(React.createElement(Router, { routes: routeConfig, history: history }), document.getElementById("body"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qs = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = (function (_React$Component) {
	    ...
	    function Index(props, context) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Index).call(this, props, context));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navs = (function (_React$Component) {
	    ...
	    function Navs(props, context) {
	        _classCallCheck(this, Navs);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Navs).call(this, props, context));
	    }
	    ...
	    _createClass(Navs, [{
	        ...
	        value: function render() {
	            ...
	            var list = navs.map(function (nav) {
	                return React.createElement("li", { key: nav.hash, className: "item" }, React.createElement(Link, { activeClassName: "active", className: "title", to: "/" + nav.hash }, nav.name));
	            });

	            return React.createElement("div", { className: "nav-box" }, React.createElement("ul", null, list));
	        }
	    }]);
